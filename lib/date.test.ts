...
import { brDateLabel, daysBetween, monthKey, parseMonthKey, shortDateLabel } from "./date";
...
describe("brDateLabel", () => {
  it("converte YYYY-MM-DD pra DD/MM/YYYY", () => {
    expect(brDateLabel("2026-08-26")).toBe("26/08/2026");
    expect(brDateLabel("2026-01-05")).toBe("05/01/2026");
  });
});
